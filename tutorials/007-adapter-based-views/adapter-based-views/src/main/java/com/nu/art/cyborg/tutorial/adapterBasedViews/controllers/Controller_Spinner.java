package com.nu.art.cyborg.tutorial.adapterBasedViews.controllers;
...
import com.nu.art.cyborg.tutorial.adapterBasedViews.R;

/**
 * Created by TacB0sS on 20-May 2017.
 */

public class Controller_Spinner
	...
	@ViewIdentifier(viewId = R.id.SP_Example,
	                listeners = {
	...
	public Controller_Spinner() {
		super(R.layout.controller__spinner);
	}
	...
	private class Renderer_Integer
		...
		Renderer_Integer() {
			super(R.layout.renderer__number_spinner);
		}
